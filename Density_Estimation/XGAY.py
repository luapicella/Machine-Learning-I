...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar 28 11:27:34 2021
...
def GAU_logpdf(x, mu, v):
    ...
    # 1-dim array"""
    return (-0.5*np.log(2*np.pi))-0.5*np.log(v)-(((x-mu)**2)/(2*v))
